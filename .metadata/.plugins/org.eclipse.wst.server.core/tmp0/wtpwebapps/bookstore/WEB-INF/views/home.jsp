    ...
    <div class="navbar-header">
     ...
     <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <c:forEach items="${categoryList}" var="category">
               <li class="dropdown">
               <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="false" aria-expanded="true">${category.name}</a> <span class="caret"></span>
          
           <ul class="dropdown-menu">
          <c:forEach items="${category.sub_Categories}" var="sub_categories">
            <li><a href="#"><b>${sub_categories.name}</b></a></li> 
         
             <c:forEach items="${sub_categories.products}" var="product">
